...
<div class="">
    <nav class="mb-2 breadcrumb-sticky-top" aria-label="breadcrumb">
      <ol class="breadcrumb mb-0">
        <li class="breadcrumb-item"><a href="timeline.html#!">Pages</a></li>
    ...
    <div class="row gx-xl-8 gx-xxl-11">
      <div class="col-xl-5 p-xxl-7">
        <div class="ms-xxl-3 d-none d-xl-block position-sticky" style="top: 30%"><img class="d-dark-none img-fluid" src="https://img.freepik.com/vector-premium/banner-arte-espacial-galaxia-fondo-espacio-abstracto-web-impresion-diseno-redes-sociales_391155-329.jpg" alt="" /><img class="d-light-none img-fluid" src="../assets/img/spot-illustrations/timeline-dark.png" alt="" /></div>
      </div>
            ...
            <div class="timeline-item">
              <div class="row g-3">
                ...
                <div class="col">
                  ...
                  <h6 class="fs--2 fw-normal mb-3">by <a class="fw-semi-bold" href="timeline.html#!">John N. Ward</a></h6>
            ...
            <div class="timeline-item">
              <div class="row g-3">
                ...
                <div class="col">
                  ...
                  <h6 class="fs--2 fw-normal mb-3">by <a class="fw-semi-bold" href="timeline.html#!">Edward Hopper</a></h6>
            ...
            <div class="timeline-item">
              <div class="row g-3">
                ...
                <div class="col">
                  ...
                  <h6 class="fs--2 fw-normal mb-3">by <a class="fw-semi-bold" href="timeline.html#!">Eye before Thy Hospital</a></h6>
            ...
            <div class="timeline-item">
              <div class="row g-3">
                ...
                <div class="col">
                  ...
                  <h6 class="fs--2 fw-normal false">by <a class="fw-semi-bold" href="timeline.html#!">John N. Ward</a></h6>
                ...
                <div class="col">
                  <div class="d-flex justify-content-between">
                    <div class="d-flex mb-2">
                      ...
                      <h6 class="mb-0 fs--1"><span class="fa-solid fa-file-pdf me-1 text-700"></span><a href="timeline.html#!">Readme.pdf</a></h6>
                    </div>
                    <p class="text-500 fs--1 mb-0 text-nowrap timeline-time"><span class="fa-regular fa-clock me-1"></span>10:33pm</p>
                  </div>
                  <h6 class="fs--2 fw-normal false">by <a class="fw-semi-bold" href="timeline.html#!">John N. Ward</a></h6>
