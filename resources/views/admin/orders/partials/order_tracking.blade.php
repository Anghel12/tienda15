            ...
            <div class="container-small cart">
              <nav class="mb-2" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                  <li class="breadcrumb-item"><a href="order-tracking.html#!">Page 1</a></li>
                  <li class="breadcrumb-item"><a href="order-tracking.html#!">Page 2</a></li>
              ...
              <div class="d-flex flex-wrap justify-content-between align-items-end mb-5">
                <div>
                  ...
                  <p class="text-800 mb-0">Payment Via <a class="fw-bold" href="order-tracking.html#!">Cash on delivery</a>,<br class="d-sm-none"><span class="ms-sm-1">Nov 12, 2021, 8:54AM.</span></p>
