<div class="form-group">
    ...
    {!! Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'ingrese el Titulo de el Bolg']) !!}
...
<div class="form-group">
    ...
    {!! Form::text('body', null, ['class' => 'form-control', 'placeholder' => 'ingrese el cuerpo de EL Blog']) !!}
